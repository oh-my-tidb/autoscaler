...
var (
	...
	costOptimizationEnabled                 = flag.Bool("cost-optimization-enabled", false, "Whether to enable/disable cost optimization, defaults to false")
	redundantNodeGroupAllocationCount       = flag.Int("redundant-node-group-allocation-count", 0, "Number of node groups to allocate redundantly during scale-up to ensure successful allocation.")
...
func createAutoscalingOptions() config.AutoscalingOptions {
	...
	return config.AutoscalingOptions{
		...
		RedundantNodeGroupAllocationCount:  *redundantNodeGroupAllocationCount,
